...
function LiveClock() {
  ...
  return (
    <div className="mkt-clock">
      <div className="mkt-clock-time">
        {pad(time.getHours())}:{pad(time.getMinutes())}:{pad(time.getSeconds())}
      </div>
      <div className="mkt-clock-date">
...
const CHAT_MSGS = [
  ...
  {
    role: 'ai',
    text: 'This is a local AI coding assistant — a React + Python bridge over bzcode. The frontend handles four agent modes (General, Widget, Worker, Coder) each with its own UI layout and identity.',
  },
  { role: 'user', text: 'What files should I look at first?' },
  {
    role: 'ai',
    text: 'Start with server.py (WebSocket bridge), src/routes/_app/agent.tsx (main agent UI), and agent_modes.json (mode configuration).',
  },
];
...
const DOC_LINES = [
  ...
  { indent: 0, bold: true, text: 'Executive Summary' },
  {
    indent: 0,
    bold: false,
    text: 'BoltzAgent is a local-first AI coding assistant that wraps bzcode into a multi-mode workspace for developers and knowledge workers.',
  },
  { indent: 0, bold: false, text: '' },
      ...
      <div className="mkt-coder-body">
        ...
        <div className="mkt-coder-tree">
          ...
          {TREE.map((f, i) => (
            <div
              key={i}
              className={`mkt-coder-tree-item${f === '    EditorPanel.tsx' ? ' mkt-coder-tree-item--active' : ''}`}
        ...
        <div className="mkt-coder-editor">
          {CODE_LINES.slice(0, codeLines).map((line, i) => (
            <div key={i} className="mkt-coder-line">
              ...
              {line.map((tok, j) => (
                <span key={j} style={{ color: tokColor[tok.c] ?? '#D4D4D4' }}>
                  {tok.t}
                </span>
              ))}
        ...
        return (
          <span key={n} className="mkt-ll-star" style={{ '--fill': fill } as React.CSSProperties}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
              ...
              />
              <clipPath id={`sf${n}`}>
                <rect x="0" y="0" width={`${fill * 12}`} height="12" />
              </clipPath>
              <path
                d="M6 1l1.3 2.6L10 4.1l-2 1.9.5 2.8L6 7.5l-2.5 1.3.5-2.8-2-1.9 2.7-.5z"
                fill="#F59E0B"
    ...
    <div className="mkt-ll">
      ...
      <div className="mkt-ll-chat">
        ...
        <div className="mkt-chat-msg mkt-chat-msg--ai">
          ...
          <span className="mkt-chat-bubble">
            Done — updated auth.ts, added token refresh logic, and wrote tests.
          </span>
        </div>
...
const TESTIMONIALS = [
  {
    ...
    quote:
      'Coder mode is the only agent that actually understands our monorepo. It runs the build, reads the error, fixes it — and the Live Learning means it stops making the same mistakes after a few sessions.',
    color: '#1473DF',
  },
  {
    initials: 'SR',
    ...
    quote:
      'Worker mode drafts our marketing copy, then I edit directly in the same panel the agent is watching. It picks up my voice after two sessions and I barely need to revise anymore.',
    color: '#2DB970',
  },
  {
    initials: 'MT',
    ...
    quote:
      'I vibe-coded an entire internal dashboard in Widget mode in an afternoon. The bar chart connected to our Postgres data, the agent helped wire it all up. Nothing left my machine.',
    color: '#8250DF',
  },
];
...
function MarketingPage() {
  ...
  function handleCTA() {
    void navigate({ to: loggedIn ? '/' : '/login' });
  }
    ...
    <div className="mkt-root">
      ...
      <nav className={`mkt-nav${scrolled ? ' mkt-nav--scrolled' : ''}`}>
        ...
        <div className="mkt-nav-links">
          <a href="#features" className="mkt-nav-link">
            Features
          </a>
          <a href="#modes" className="mkt-nav-link">
            Modes
          </a>
      ...
      <section className="mkt-hero">
        ...
        <div className="mkt-hero-inner">
          ...
          <div className="mkt-hero-actions">
            ...
            <a href="#modes" className="mkt-btn mkt-btn--ghost">
              See the modes ↓
            </a>
          </div>
        </div>
        ...
        <div className="mkt-ll-section-inner">
          <div className="mkt-ll-text">
            ...
            <p className="mkt-feature-p">
              ...
              Boltzbit's Live Learning goes further: type{' '}
              <code className="mkt-inline-code">/learn</code> and the model updates its own weights
              from your conversation history. Version after version, it gets faster, more accurate,
              and needs fewer tokens to do the same work.
            </p>
            <ul className="mkt-ll-list">
              <li>
                <strong>Model versioning</strong> — every learning run bumps the version number
              </li>
              <li>
                <strong>Higher accuracy</strong> — weight updates reduce repeated mistakes
              </li>
              <li>
                <strong>Better efficiency</strong> — the model knows your patterns, costs less to
                run
              </li>
              <li>
                <strong>Per-mode learning</strong> — Coder, Worker, and Widget modes each train
                separately
              </li>
            </ul>
          </div>
      ...
      <section className="mkt-testimonials">
        <div className="mkt-section-inner">
          ...
          <p className="mkt-section-sub">
            From solo developers to content teams — BoltzAgent adapts to how you work.
          </p>
            ...
            {TESTIMONIALS.map(t => (
              <div key={t.name} className="mkt-testi-card">
                ...
                <div className="mkt-testi-author">
                  <span className="mkt-testi-avatar" style={{ background: t.color }}>
                    {t.initials}
                  </span>
                  <div>
      ...
      <section className="mkt-cta">
        ...
        <p className="mkt-cta-sub">
          Log in to open your agent workspace. Runs entirely on your machine.
        </p>
      ...
      <footer className="mkt-footer">
        ...
        <span className="mkt-footer-copy">
          © {new Date().getFullYear()} Boltzbit. All rights reserved.
        </span>
      </footer>
    </div>
  );
