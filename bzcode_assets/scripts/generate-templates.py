...
{
 "id":"meeting-minutes","title":"Meeting Minutes",
...
{
 "id":"contract","title":"Contract / Agreement",
...
{
 "id":"weekly-update","title":"Weekly Update / Status Report",
...
# ═══════════════════════════════════════════════════════════════════════════════
{
 ...
 "use_cases":["Build a business case for a new system","Justify a budget request","Make the case for a new initiative"],
 "content":"""\
...
{
 "id":"requirements-spec","title":"Requirements Specification",
...
{
 "id":"swot-analysis","title":"SWOT / Competitive Analysis",
...
{
 "id":"stakeholder-analysis","title":"Stakeholder Analysis",
 "profiles":["business-analyst","project-manager"],
...
{
 "id":"kpi-report","title":"KPI / Performance Dashboard Report",
...
{
 "id":"change-management-plan","title":"Change Management Plan",
 ...
 "use_cases":["Write a change management plan","Plan an organisational change","Create a change comms strategy"],
 "content":"""\
...
# ═══════════════════════════════════════════════════════════════════════════════
{
 "id":"campaign-brief","title":"Campaign Brief",
 "profiles":["marketing"],
...
{
 "id":"blog-post","title":"Blog Post / Article",
...
{
 "id":"social-media-pack","title":"Social Media Copy Pack",
 "profiles":["marketing"],
...
{
 "id":"brand-messaging","title":"Brand Messaging Guide",
 "profiles":["marketing","startup"],
...
{
 "id":"email-sequence","title":"Email Sequence (Drip Campaign)",
...
{
 "id":"case-study","title":"Case Study / Customer Story",
 "profiles":["marketing","sales"],
...
{
 "id":"product-launch-plan","title":"Product Launch Plan",
...
{
 "id":"seo-brief","title":"SEO Content Brief",
 "profiles":["marketing"],
...
{
 "id":"compliance-audit","title":"Compliance Audit Report",
...
{
 "id":"legal-memo","title":"Legal Memorandum",
 "profiles":["legal"],
...
{
 "id":"incident-report","title":"Incident Report",
...
{
 "id":"performance-review","title":"Performance Review",
...
{
 "id":"onboarding-plan","title":"Onboarding Plan",
 "profiles":["hr"],
...
{
 "id":"hr-policy","title":"HR Policy Document",
 "profiles":["hr"],
...
# ═══════════════════════════════════════════════════════════════════════════════
{
 "id":"pitch-deck-outline","title":"Pitch Deck Outline",
...
{
 "id":"rfp-response","title":"RFP Response",
...
{
 "id":"account-plan","title":"Account Plan",
 "profiles":["sales"],
...
{
 "id":"win-loss-analysis","title":"Win / Loss Analysis",
 "profiles":["sales","business-analyst"],
...
# ═══════════════════════════════════════════════════════════════════════════════
{
 "id":"project-plan","title":"Project Plan",
...
{
 "id":"retrospective","title":"Retrospective Report",
 "profiles":["project-manager"],
...
{
 "id":"project-closure","title":"Project Closure Report",
 "profiles":["project-manager"],
...
# ═══════════════════════════════════════════════════════════════════════════════
{
 "id":"financial-summary","title":"Financial Summary Report",
 "profiles":["finance"],
...
{
 "id":"board-financial-report","title":"Board Financial Report",
...
# ═══════════════════════════════════════════════════════════════════════════════
{
 ...
 "profiles":["researcher"],
 "keywords":["literature review","research","academic","papers","sources","bibliography","systematic review"],
...
{
 "id":"grant-application","title":"Grant Application",
 "profiles":["researcher"],
...
{
 "id":"data-analysis-summary","title":"Data Analysis Summary",
...
# ═══════════════════════════════════════════════════════════════════════════════
{
 "id":"one-pager","title":"One-Pager / Company Overview",
...
{
 "id":"okr-document","title":"OKR Document",
...
{
 "id":"investor-update","title":"Investor Update",
...
# ═══════════════════════════════════════════════════════════════════════════════
{
 ...
 "keywords":["sop","standard operating procedure","process","procedure","operations","workflow","instructions"],
...
{
 "id":"post-mortem","title":"Post-Mortem / Incident Analysis",
...
{
 "id":"sla","title":"Service Level Agreement (SLA)",
...
{
 "id":"vendor-evaluation","title":"Vendor / Supplier Evaluation",
 "profiles":["operations","procurement","finance"],
 "keywords":["vendor","supplier","evaluation","procurement","rfq","selection","comparison","due diligence"],
...
{
 "id":"process-improvement","title":"Process Improvement Proposal",
