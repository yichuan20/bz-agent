export const PlusIcon = ({ height = '12px', style = {}, className = '' }) => (
  <svg
...
export const TrashIcon = ({ height = '16px', style = {}, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    height={height}
...
export const UploadIcon = ({ height = '16px', style = {}, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    height={height}
...
export const MoreVertIcon = ({ height = '16px', style = {}, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    height={height}
...
export const FormulaIcon = ({ height = '20px', className, style = {}, onClick = () => {} }) => (
  ...
  >
    ...
    />
    <path
      d="M75.3,46.4c1.6,0,4.7-1.3,4.7-5.5c0-4.2-3-4.4-4-4.4c-1.8,0-3.7,1.3-5.3,4.1c-1.6,2.8-3.4,6-3.4,6l-0.1,0
...
export const LogoInner = ({ height = '16px', className, style = {}, onClick = () => {} }) => (
  ...
  >
    ...
    <path d="M20.9595 12.7006C21.0062 12.6217 20.9997 12.5365 20.9997 12.4339C20.9997 12.361 20.9997 12.2903 20.9997 12.2396V8.625C20.9997 8.46875 20.9375 8.33333 20.8338 8.21875L12.9213 0.229167C12.8176 0.09375 12.6517 0 12.465 0H8.58654C8.44136 0 8.29617 0.0625 8.19247 0.166667L0.383698 7.95833H0.373328C0.176294 8.04167 0.0518511 8.21875 0.0207404 8.42708C0.0103702 8.47917 0 8.53125 0 8.58333C0 8.625 0.0103702 8.67708 0.0207404 8.71875V12.3854C0.0207404 12.5417 0.0829617 12.6771 0.186664 12.7917L8.16136 20.8438C8.24432 20.9271 8.35839 20.9896 8.48284 21C8.50358 21 8.51395 21 8.53469 21C8.54506 21 8.55543 21 8.5658 21C8.5658 21 8.5658 21 8.57617 21H12.4443C12.5998 21 12.7346 20.9375 12.8487 20.8333L20.6678 13.0208C20.6678 13.0208 20.8787 12.8369 20.9595 12.7006ZM1.16146 9.97917L8.17173 17.0208C8.27543 17.125 8.42062 17.1875 8.57617 17.1875C8.73172 17.1875 8.8769 17.125 8.98061 17.0208L10.8265 15.1667C10.8576 15.1354 10.8784 15.1146 10.8991 15.0833L14.7153 11.3646L15.7627 12.4167L8.57617 19.6354L1.17183 12.1562V9.97917H1.16146ZM19.859 11.0104L12.8694 3.98958C12.6517 3.77083 12.2887 3.77083 12.0606 3.98958L10.2665 5.80208L6.30509 9.65625L5.30955 8.65625L5.2577 8.60417L11.4176 2.41667L12.4546 1.38542L19.859 8.86458V11.0104ZM10.4117 13.9375L7.08286 10.4896L10.6087 7.0625L13.9376 10.5104L10.4117 13.9375ZM11.0754 1.14583L10.6295 1.59375L4.04438 8.17708C3.87846 8.34375 3.83698 8.60417 3.93031 8.8125C3.96142 8.88542 4.0029 8.95833 4.05475 9.01042L4.50067 9.45833L9.59245 14.7396L8.5658 15.7396L1.43109 8.53125L8.82505 1.14583H11.0754ZM9.95541 19.8646L16.9864 12.8333C17.2042 12.6146 17.2146 12.25 16.9968 12.0312L11.428 6.26042L12.4443 5.27083L19.5893 12.4896L12.2057 19.8646H9.95541Z" />
  </svg>
);

export const BoltzhubLogoInner = ({
  height = '16px',
  className,
  style = {},
  onClick = () => {},
  ...
  >
    <g clipPath="url(#clip0_525_770)">
      ...
      <path d="M13.2515 17.5989H8.83496V21.9981H13.2515V17.5989Z" />
      <path d="M17.668 13.1996H13.2515V17.5988H17.668V13.1996Z" />
      <path d="M4.41653 8.80042H0V13.1996H4.41653V8.80042Z" />
      <path d="M8.83303 8.80042H4.4165V13.1996H8.83303V8.80042Z" />
      <path d="M17.668 8.80042H13.2515V13.1996H17.668V8.80042Z" />
      <path d="M22.0845 8.80042H17.668V13.1996H22.0845V8.80042Z" />
      <path d="M8.83303 4.39929H4.4165V8.79852H8.83303V4.39929Z" />
      <path d="M13.2515 4.39929H8.83496V8.79852H13.2515V4.39929Z" />
      <path d="M8.83303 0H4.4165V4.39923H8.83303V0Z" />
      <path d="M17.668 4.39929H13.2515V8.79852H17.668V4.39929Z" />
    </g>
    <defs>
      <clipPath id="clip0_525_770">
        <rect width="22.0865" height="22" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
...
export const EmailIcon = ({ height = '20px', className, style = {}, onClick = () => {} }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M36.0069 0.626704L70 26.2523V64H1.5V26.2454L36.0069 0.626704ZM4.5 29.4271L32.8321 43.5931L4.5 59.9055V29.4271ZM8.61149 61H62.9621L35.9943 45.2342L8.61149 61ZM35.9948 41.8204L65.6775 26.7507L35.9931 4.3733L5.8535 26.7497L35.9948 41.8204ZM67 29.4438L39.1308 43.5928L67 59.8856V29.4438Z"
    />
    <path d="M5.5 62.5C5.5 63.8807 4.38071 65 3 65C1.61929 65 0.5 63.8807 0.5 62.5C0.5 61.1193 1.61929 60 3 60C4.38071 60 5.5 61.1193 5.5 62.5Z" />
    <path d="M71 62.5C71 63.8807 69.8807 65 68.5 65C67.1193 65 66 63.8807 66 62.5C66 61.1193 67.1193 60 68.5 60C69.8807 60 71 61.1193 71 62.5Z" />
    <path d="M5.5 27.5C5.5 28.8807 4.38071 30 3 30C1.61929 30 0.5 28.8807 0.5 27.5C0.5 26.1193 1.61929 25 3 25C4.38071 25 5.5 26.1193 5.5 27.5Z" />
    <path d="M71 27.5C71 28.8807 69.8807 30 68.5 30C67.1193 30 66 28.8807 66 27.5C66 26.1193 67.1193 25 68.5 25C69.8807 25 71 26.1193 71 27.5Z" />
    <path d="M38.5 2.5C38.5 3.88071 37.3807 5 36 5C34.6193 5 33.5 3.88071 33.5 2.5C33.5 1.11929 34.6193 0 36 0C37.3807 0 38.5 1.11929 38.5 2.5Z" />
  </svg>
);
...
export const CubeIcon = ({ className, height = '14px' }) => (
  <svg viewBox="0 0 100 100" height={height} className={className} aria-hidden="true">
	...
	c0,1.5,0.8,3,2.1,3.8V69c-1.4,0.8-2.3,2.3-2.3,4c0,2.5,2,4.5,4.5,4.5c0.8,0,1.6-0.2,2.3-0.6l32.6,18.8c0.1,2.4,2.1,4.3,4.5,4.3
	c2.3,0,4.3-1.8,4.5-4.1l33.2-19.2c0.7,0.4,1.4,0.6,2.2,0.6c2.5,0,4.5-2,4.5-4.5C94.2,71.1,93.2,69.6,91.7,68.8z M47.4,8.3
	c0.1,0.1,0.2,0.1,0.4,0.2v38L15.2,27.7c0-0.1,0-0.2,0-0.3c0-0.2,0-0.4,0-0.5L47.4,8.3z M12.4,69V31.6c0.2-0.1,0.4-0.2,0.6-0.3
	L45.5,50c0,0.2,0,0.3,0,0.5c0,0.8,0.2,1.6,0.6,2.2L12.9,69.3C12.7,69.2,12.5,69,12.4,69z M47.9,91.4c-0.3,0.1-0.6,0.3-0.9,0.5
	l-32.4-18.7c0.1-0.3,0.2-0.6,0.2-0.9c0-0.2,0-0.4,0-0.5l33.1-16.5V91.4z M49.9,50.5c-0.2,0-0.5,0-0.7,0.1c-0.3,0-0.5,0.1-0.7,0.2
	L16.1,69.3c-0.1-0.1-0.2-0.2-0.3-0.3V31.6c0.2-0.1,0.4-0.2,0.6-0.3L45.5,50C45.7,50.3,45.9,50.5,49.9,50.5z M52.1,91.4V55.3
	l33.2,16.6c0,0.1,0,0.2,0,0.3c0,0.4,0.1,0.7,0.2,1L52.9,91.9C52.6,91.7,52.4,91.5,52.1,91.4z M87.6,69V31.6
	c0.2,0.1,0.4,0.2,0.6,0.3V69C88,69.2,87.8,69.1,87.6,69z M84.8,27.7L52.2,46.5v-38c0.1-0.1,0.3-0.1,0.4-0.2l32.2,18.6
	C84.8,27.1,84.8,27.4,84.8,27.7z M53.9,52.7c0.4-0.6,0.6-1.4,0.6-2.2c0-0.2,0-0.3,0-0.5l32.5-18.8c0.2,0.1,0.4,0.2,0.6,0.3V69
	c-0.1,0.1-0.3,0.2-0.4,0.3L53.9,52.7z"
    />
  </svg>
);
